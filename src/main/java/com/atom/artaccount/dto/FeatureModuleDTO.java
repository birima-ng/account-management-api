...
public class FeatureModuleDTO {
    ...
    private List<SubFeatureModuleDTO> subfeatures;
	...
	public List<SubFeatureModuleDTO> getSubfeatures() {
		return subfeatures;
	}

	public void setSubfeatures(List<SubFeatureModuleDTO> subfeatures) {
